    ...
    <div class="max-w-3xl">
        <div class="overflow-hidden bg-white border border-gray-200 shadow-sm rounded-xl">
            <div class="px-6 py-5 border-b border-gray-200 bg-gradient-to-r from-indigo-50 to-indigo-100">
                ...
                <p class="mt-1 text-sm text-gray-600">Actualiza los datos del miembro del staff</p>
            </div>
            ...
            <form method="POST" action="{{ route('admin.staff.update', $staff) }}" class="p-6 space-y-6">
                ...
                <!-- Status -->
                <div class="flex items-center">
                    <input id="is_active" name="is_active" type="checkbox" value="1" {{ old('is_active', $staff->is_active) ? 'checked' : '' }}
